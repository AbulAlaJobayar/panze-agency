      ...
      >
        ...
        >
          <div>
            ...
            <motion.input
              ...
              required
              className=" w-full border-white/20 border px-5 py-3 capitalize focus:outline-none  font-dm-mono text-[14px] leading-[150%] tracking-[-4%] font-normal focus:border-primary text-primary"
            />
          </div>
          <div>
            ...
            <motion.input
              ...
              required
              className="w-full border-white/20 border px-5 py-3 capitalize focus:outline-none  font-dm-mono text-[14px] leading-[150%] tracking-[-4%] font-normal focus:border-orange-500 text-primary"
            />
          </div>
        </motion.div>
        ...
        <motion.div variants={selectVariant} className="relative">
          ...
          <div className="relative">
            <motion.button
              ...
              className="w-full  text-left flex justify-between items-center focus:outline-none   border-white/20 border px-5 py-3 capitalize  font-dm-mono text-[14px] leading-[150%] tracking-[-4%] font-normal focus:border-orange-500 text-primary"
            >
              {selectedService}
              <motion.span
            ...
            <AnimatePresence>
              {isServiceOpen && (
                <motion.div
                  ...
                  className="absolute z-50 w-full mt-2 bg-zinc-900 border border-white/20 rounded-2xl overflow-hidden shadow-2xl"
                >
              ...
              <motion.button
                ...
                className={` font-dm-mono text-[14px] leading-[150%] tracking-[-4%] font-normal px-4 py-3  text-sm transition-all border duration-200 ${
                  selectedBudget === b.value
                    ...
                    : " text-primary hover:border-zinc-500 border-white/20 "
                }`}
              >
                {b.label}
              </motion.button>
        ...
        <motion.div variants={selectVariant} className="relative">
          ...
          <div className="relative">
            <motion.button
              ...
              whileHover={{ scale: 1.01 }}
              className="w-full  border border-white/20  px-5 py-3 text-left flex justify-between items-center focus:outline-none focus:border-primary text-primary font-dm-mono text-[14px] leading-[150%] tracking-[-4%] font-normal"
            >
              {selectedSource}
              <motion.span
        ...
        <motion.div variants={selectVariant}>
          ...
          <motion.textarea
            ...
            required
            className="w-full  border border-white/20  px-5 py-4 focus:outline-none focus:border-orange-500 resize-y text-primary font-dm-mono text-[14px] leading-[150%] tracking-[-4%] font-normal"
          />
        </motion.div>
